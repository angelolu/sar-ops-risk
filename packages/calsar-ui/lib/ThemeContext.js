  ...
  var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(key) {
    ...
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        ...
        case 1:
          jsonValue = _context.v;
          return _context.a(2, jsonValue != null ? JSON.parse(jsonValue) : null);
        case 2:
          _context.p = 2;
          _t = _context.v;
        case 3:
...
var extractThemeFromScheme = function extractThemeFromScheme(scheme) {
  var theme = scheme === 'light' ? _theme["default"].schemes.light : _theme["default"].schemes.dark;
  theme = _objectSpread(_objectSpread({}, theme), _theme["default"].customColors);
  return theme;
};
var ThemeProvider = exports.ThemeProvider = function ThemeProvider(_ref2) {
  ...
  var _useState3 = (0, _react.useState)(extractThemeFromScheme(colorScheme)),
    _useState4 = _slicedToArray(_useState3, 2),
    colorTheme = _useState4[0],
    setColorTheme = _useState4[1];
  var _useState5 = (0, _react.useState)(null),
    _useState6 = _slicedToArray(_useState5, 2),
    savedScheme = _useState6[0],
    setSavedScheme = _useState6[1];
  var changeColorScheme = function changeColorScheme(scheme) {
  ...
  (0, _react.useEffect)(function () {
    ...
    getData("appearance").then(function (value) {
      if (value === 2) {
  ...
  (0, _react.useEffect)(function () {
    var subscription = _reactNative.Appearance.addChangeListener(function (preferences) {
      // skip updating the scheme if the scheme is overridden by the user
      if (savedScheme === null) {
        var scheme = preferences === null || preferences === void 0 ? void 0 : preferences.colorScheme;
  ...
  var getHoverColor = function getHoverColor(baseColorHex) {
